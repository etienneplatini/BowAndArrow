...
// this is the master game script, attached to the bow
...
public class bowAndArrow : MonoBehaviour {
	...
	public void setPoints(int points){
		...
		if (points == 50) {
			...
			rt1.GetComponent<TextMesh>().text= "+1 Flèche Bonus !";
		}
	}
	...
	public void shareOnFacebook() { 
		storeUrl = "https://play.google.com/store/apps/details?id=com.ionicframework.artmajeur632922&hl=fr";
